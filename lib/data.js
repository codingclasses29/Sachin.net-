...
export const socialLinks = [
  {
    ...
    icon: "whatsapp",
    href: "https://whatsapp.com/channel/0029VbBhyVHKAwEohciKUo1R",
  },
...
export const trustedCompanies = [
  "Bright School", "TrendyKart", "MedCare Hospital", "BuildTech", "Real Estate Pro", "EduSmart", "BizCRM", "Coaching Plus",
];

export const timeline = [
  { year: "2020", title: "Founded", desc: "Sachin.net started with a vision to make premium tech affordable for every business." },
  { year: "2021", title: "First 50 Projects", desc: "Delivered websites and school ERP systems across Bihar and India." },
  { year: "2022", title: "Team Expansion", desc: "Added AI/ML specialists and full-stack developers to the team." },
  { year: "2023", title: "E-Commerce Focus", desc: "Launched dedicated e-commerce and payment gateway solutions." },
  { year: "2024", title: "AI Integration", desc: "Integrated ChatGPT, Gemini and custom AI chatbots for clients." },
  { year: "2025", title: "ML Platform", desc: "Built machine learning services — prediction, vision, NLP." },
  { year: "2026", title: "100+ Clients", desc: "Serving 100+ happy clients with websites, ERP, AI & ML solutions." },
];

export const careerJobs = [
  { title: "Full Stack Developer", type: "Full-time / Remote", desc: "Next.js, React, Node.js experience required." },
  { title: "Python ML Engineer", type: "Full-time / Remote", desc: "TensorFlow, PyTorch, FastAPI experience." },
  { title: "UI/UX Designer", type: "Part-time", desc: "Figma, modern design systems, portfolio required." },
  { title: "Digital Marketing Intern", type: "Internship", desc: "SEO, social media, content marketing." },
];
...
export const services = [
  ...
  },
  {
    ...
    desc: "Custom AI chatbots, ML models, computer vision and predictive analytics.",
    points: ["ChatGPT/Gemini Bots", "TensorFlow Models", "Computer Vision"],
    color: "#06b6d4",
  },
  {
    icon: "erp",
    title: "CRM Software",
    desc: "Customer relationship management with leads, follow-ups and sales reports.",
    points: ["Lead Management", "Pipeline Tracking", "Sales Analytics"],
    color: "#6366f1",
  },
  {
    icon: "school",
    title: "Hospital Software",
    desc: "Hospital management with appointments, billing, pharmacy and records.",
    points: ["Appointments", "Billing", "Patient Records"],
    color: "#14b8a6",
  },
  {
    icon: "cart",
    title: "Restaurant Software",
    desc: "POS, table management, online ordering and kitchen display system.",
    points: ["POS System", "Online Orders", "Inventory"],
    color: "#f97316",
  },
  {
    icon: "api",
    title: "Digital Marketing",
    desc: "SEO, social media, Google Ads and content marketing for growth.",
    points: ["SEO", "Social Media", "Google Ads"],
    color: "#ec4899",
  },
];
...
export const faqs = [
  ...
  {
    q: "AI Chatbot aur ML solutions bhi provide karte ho?",
    a: "Haan! Hum ChatGPT/Gemini chatbots, machine learning models, computer vision, NLP aur predictive analytics sab develop karte hain.",
  },
  {
    q: "School ERP system me kya-kya features hote hain?",
    a: "Admissions, fee management, attendance, exams, results, parent portal, teacher dashboard aur SMS/WhatsApp alerts — sab included.",
  },
  {
    q: "Kya aap existing website ko redesign kar sakte ho?",
    a: "Bilkul! Hum purani websites ko modern design, fast speed aur SEO ke saath upgrade karte hain.",
  },
  {
    q: "Custom software ki cost kaise decide hoti hai?",
    a: "Requirements discussion ke baad hum detailed quote dete hain. Free consultation available hai — contact karein.",
  },
  {
    q: "Kaunse technologies use karte ho?",
    a: "Next.js, React, Node.js, MongoDB, Python, FastAPI, TensorFlow, PyTorch — latest aur proven technologies.",
  },
];
